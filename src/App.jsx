...
const Slider = () => (
    <Container className="mt-5">
        ...
        <Carousel className="carousel">
            <Carousel.Item>
                <img className="d-block w-100" src="https://www.ekologia.pl/wp-content/uploads/2023/03/marsh-frog-pelophylax-ridibundus_800x533.jpg" alt="Żaba śmieszka" />
                <Carousel.Caption>
                    <h3>Żaba śmieszka</h3>
            ...
            <Carousel.Item>
                <img className="d-block w-100" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/%C5%BBaba_jeziorkowa.JPG/1280px-%C5%BBaba_jeziorkowa.JPG" alt="Żaba jeziorkowa" />
                <Carousel.Caption>
            ...
            <Carousel.Item>
                <img className="d-block w-100" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Teichfrosch.jpg/1024px-Teichfrosch.jpg" alt="Żaba wodna" />
                <Carousel.Caption>
                    <h3>Żaba wodna</h3>
...
const Karty = () => (
    <Container className="card-container">
        <h2>Karty</h2>
        <Card className="card">
            <Card.Img className="card-image" variant="top" src="https://zwierzakwdomu.pl/wp-content/uploads/2021/01/frog-peeking-out-P2KMUJV-scaled.jpg" />
            <Card.Body>
